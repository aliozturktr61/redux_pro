...
const buttonUpdateFunc=()=>{
  ...
  const contentModal=(
    <>
       ...
       <Input type={"file"}placeholder={"Resim Seç"} name={"url"} id={"url"} onChange={e=>onChangeFunc(e,"url")}/>
        <Button btnText={loc?"Ürün Gümcelle":"Ürün Oluştur"} onClick={loc?buttonUpdateFunc():buttonFunc()}/>
    </>
  )
  ...
  return (
    <div>
      ...
      {modal && <Modal content={contentModal} title={loc?"Ürün Gümcelle":"Ürün Oluştur"} />}
    </div>
  );
};
